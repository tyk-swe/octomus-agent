...
operator token; the destination must be an `http(s)` URL without user
information in its authority. Point it at a receiver you control (ntfy, a chat relay, a small
