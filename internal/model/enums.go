...
func (v Status) String() string               { return jsoncompat.EnumName(uint8(v), statusNames) }
func (v Status) MarshalJSON() ([]byte, error) { return jsoncompat.MarshalEnum(uint8(v), statusNames) }
func (v *Status) UnmarshalJSON(data []byte) error {
	n, err := jsoncompat.Enum(data, statusNames)
	if err == nil {
		*v = Status(n)
	}
	return err
...
func (v BlockedReason) String() string { return jsoncompat.EnumName(uint8(v), blockedReasonNames) }
func (v BlockedReason) MarshalJSON() ([]byte, error) {
	return jsoncompat.MarshalEnum(uint8(v), blockedReasonNames)
}
func (v *BlockedReason) UnmarshalJSON(data []byte) error {
	n, err := jsoncompat.Enum(data, blockedReasonNames)
	if err == nil {
		*v = BlockedReason(n)
	}
	return err
...
func (v PlanningCapacityStatus) String() string {
	return jsoncompat.EnumName(uint8(v), planningCapacityStatusNames)
}
func (v PlanningCapacityStatus) MarshalJSON() ([]byte, error) {
	return jsoncompat.MarshalEnum(uint8(v), planningCapacityStatusNames)
}
func (v *PlanningCapacityStatus) UnmarshalJSON(data []byte) error {
	n, err := jsoncompat.Enum(data, planningCapacityStatusNames)
	if err == nil {
...
func (v BaselineStatus) String() string { return jsoncompat.EnumName(uint8(v), baselineStatusNames) }
func (v BaselineStatus) MarshalJSON() ([]byte, error) {
	return jsoncompat.MarshalEnum(uint8(v), baselineStatusNames)
}
func (v *BaselineStatus) UnmarshalJSON(data []byte) error {
	n, err := jsoncompat.Enum(data, baselineStatusNames)
	if err == nil {
		*v = BaselineStatus(n)
	}
	return err
...
func (v CycleMode) String() string { return jsoncompat.EnumName(uint8(v), cycleModeNames) }
func (v CycleMode) MarshalJSON() ([]byte, error) {
	return jsoncompat.MarshalEnum(uint8(v), cycleModeNames)
}
func (v *CycleMode) UnmarshalJSON(data []byte) error {
	n, err := jsoncompat.Enum(data, cycleModeNames)
	if err == nil {
		*v = CycleMode(n)
	}
	return err
...
func (v OperatingMode) String() string { return jsoncompat.EnumName(uint8(v), operatingModeNames) }
func (v OperatingMode) MarshalJSON() ([]byte, error) {
	return jsoncompat.MarshalEnum(uint8(v), operatingModeNames)
}
func (v *OperatingMode) UnmarshalJSON(data []byte) error {
	n, err := jsoncompat.Enum(data, operatingModeNames)
	if err == nil {
		*v = OperatingMode(n)
	}
	return err
...
func (v BatchPhase) String() string { return jsoncompat.EnumName(uint8(v), batchPhaseNames) }
func (v BatchPhase) MarshalJSON() ([]byte, error) {
	return jsoncompat.MarshalEnum(uint8(v), batchPhaseNames)
}
func (v *BatchPhase) UnmarshalJSON(data []byte) error {
	n, err := jsoncompat.Enum(data, batchPhaseNames)
	if err == nil {
		*v = BatchPhase(n)
	}
	return err
